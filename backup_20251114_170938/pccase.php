...
<div class="product-grid">
    ...
    ["id" => 83, "name" => "InPlay Meteor 03 Mid Tower Black and White Tempered Glass Gaming Case", "price" => 1095.00, "image" => "image/InPlay_Meteor_03.png"],
      ...
      ["id" => 87, "name" => "MSI MAG Forge 100R Mid Tower PC Case Black Tempered Glass", "price" => 3635.00, "image" => "image/MSI_MAG_Forge.png"],
      ...
      ["id" => 90, "name" => "LianLi LanCool 215-X ATX Mid Tower Honeycomb Gaming PC Case White", "price" => 5175.00, "image" => "image/lianli.png"],
