...
<div class="product-grid">
  ...
  ["id" => 109, "name" => "YGT TN24FHD-GD 23.8 Display FHD LED Monitor", "price" => 2190.00, "image" => "image/YGT_TN24FHD-GD.png"],
    ...
    foreach ($products as $product) {
        ...
        <div class='product-card'>
            ...
            <div class='button-group'>
                ...
                <a href="<?php echo '?action=add&product_id='.$product['id'].'&product_name='.urlencode($product['name']).'&product_price='.$product['price'].'&product_image='.$product['image']; ?>" class="ajax-add" data-id="<?php echo $product['id']; ?>" data-name="<?php echo htmlspecialchars($product['name'], ENT_QUOTES); ?>" data-price="<?php echo $product['price']; ?>" data-image="<?php echo $product['image']; ?>">
