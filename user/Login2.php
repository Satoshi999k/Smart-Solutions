...
$profileProfile = $_SESSION['profile_picture'] ?? 'Pictures/default-avatar.png';
?>
...
<body>
    <header>
      <div class="ssheader">
            ...
            <div class="dropdown">
                <img src="<?php echo htmlspecialchars($profileImage); ?>" alt="User Profile" class="profile-image" width="50" height="50">
    ...
    <div class="features">
        <img class="features" src="../image/features.png" alt="features">
    </div>
  ...
  <div class="desktop-box" style="background-image: url('image/bgdesktop.png');">
    ...
    <div class="seemore">
      <a href="desktop.html">SEE MORE</a>
    </div>
  ...
  <div class="laptop-box" style="background-image: url('image/bglaptop.png');">
    ...
    <div class="see-more"><a href="smartdeals.html">SEE MORE</a>
    </div>
