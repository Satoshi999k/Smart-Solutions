...
if (empty($products)) {
    ...
    ["id" => 4, "name" => "Lenovo V15 G4 IRU 15.6 / FHD Intel Core i5- 1335U/8GB DDR4/512GB M.2 SSD Laptop MN", "price" => 29495.00, "image" => "image/ideapad.png"],
...
// Filter cart to only selected items (if selection was made)
...
if (!empty($cart)) {
    foreach ($cart as $item) {
        // Ensure `id` exists in the cart item
        if (isset($item['id'])) {
            $product = $productsById[$item['id']] ?? null;
            ...
            if ($product !== null) {
                ...
                <div class='item-summary'>
                    ...
                    <div>
                        ...
                        <p>₱" . number_format($product['price'], 2) . " x " . $itemQuantity . " = ₱" . number_format($product['price'] * $itemQuantity, 2) . "</p>
                    </div>
                </div>";
            } else {
                // Handle case where product is not found
                $cartItems .= "<p>Error: Product with ID " . htmlspecialchars($item['id']) . " not found.</p>";
            }
        } else {
            // Handle case where cart item does not have `id`
            $cartItems .= "<p>Error: Invalid cart item format.</p>";
        }
    }
} else {
...
<body class="checkout-page">
    <header>
        <div class="logoheader">
            <div class="logocp">
                <img src="image/logocp.png" alt="Smart Solutions Logo">
            </div>
        </div>
    </header>
    ...
    <div class="checkout-container">
        <div class="checkout-left">
            <h2>Account</h2>
            <p>mrlobhl14@gmail.com</p>
            <hr>
            <form class="delivery-form" method="post" action="complete_order.php">
                ...
                <div class="shipping-container">
                    <div class="shipping-title">Shipping method</div>
                    <div class="shipping-box">
                        Enter your shipping address to view available shipping methods.
                    </div>
                </div>
                <button class="cmp-btn" type="submit">Complete Order</button>
            </form>
        </div>
        ...
        <div class="checkout-right">
            ...
            <div class="total-summary">
                ...
                <p>Shipping <span class="shipping">Enter shipping address</span></p>
      ...
      <script>
        document.getElementById('completeOrderBtn').addEventListener('click', function() {
            // Clear the cart in the session (client-side)
            sessionStorage.removeItem('cart'); //Use sessionStorage for client-side only
