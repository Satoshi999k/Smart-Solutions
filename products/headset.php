...
<div class="product-grid">
    <!-- Product Cards with IDs from 139 to 150 -->
    <?php
    $products = [
        ["id" => 139, "name" => "RAKK LIMAYA+ Trimode RGB Gaming Wireless Headset B...", "price" => 1895.00, "image" => "/ITP122/image/RAKK_LIMAYA_Trimode.png"],
        ["id" => 140, "name" => "Asus TUF Gaming H3 7.1 Gaming Headset Gun Metal / ...", "price" => 2050.00, "image" => "/ITP122/image/asus_tuf_gaming.png"],
        ["id" => 141, "name" => "ONIKUMA X32 Wired Gaming Headset RGB Black", "price" => 680.00, "image" => "/ITP122/image/ONIKUMA_X32_Wired.png"],
        ["id" => 142, "name" => "Fantech WHG03P Studio Pro 7.1 Surround Sound Heads...", "price" => 2015.00, "image" => "/ITP122/image/fantech.png"],
        ["id" => 143, "name" => "Logitech G435 Lightspeed Wireless Gaming Headset B...", "price" => 3100.00, "image" => "/ITP122/image/logitech_g435_lightspeed.png"],
        ["id" => 144, "name" => "SteelSeries HS Arctis Nova 1 AirWeave Memory Foam ...", "price" => 3550.00, "image" => "/ITP122/image/steelseries.png"],
        ["id" => 145, "name" => "Kingston HyperX Cloud II Gaming Headset Red", "price" => 5095.00, "image" => "/ITP122/image/hyperx.png"],
        ["id" => 146, "name" => "Razer Electra V2 Wired Gaming Headset Black", "price" => 3050.00, "image" => "/ITP122/image/razerheadset.png"],
        ["id" => 147, "name" => "Corsair Void Pro CSCA9011150AP RGB 7.1 Wireless Pr...", "price" => 6595.00, "image" => "/ITP122/image/corsairvoid.png"],
        ["id" => 148, "name" => "Corsair Void Pro CSCA9011156AP 7.1 Premium Gaming ...", "price" => 3825.00, "image" => "/ITP122/image/corsairheadset.png"],
        ["id" => 149, "name" => "Asus ROG Centurion 7.1 Gaming Headset", "price" => 12995.00, "image" => "/ITP122/image/asusheadset1.png"],
        ["id" => 150, "name" => "Asus ROG Strix Fusion 300 7.1 Gaming Headset", "price" => 9295.00, "image" => "/ITP122/image/asusheadset2.png"]
    ];
