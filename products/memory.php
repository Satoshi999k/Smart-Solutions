...
$result = $conn->query("SELECT id, name, price, image, stock FROM products WHERE LOWER(category) LIKE '%memory%' ORDER BY id DESC");
$products = [];
...
<div class="menu">
    ...
    <a href="../productslaptop.php">LAPTOP</a>
...
<div class="breadcrumb">
    ...
    <a><i class="material-icons" style="font-size: 16px; vertical-align: middle; margin-right: 4px;">memory</i>Memory</a>
</div>
...
<div class="product-grid">
    ...
    if (!empty($products)) {
        ...
        echo "<p style='grid-column: 1/-1; text-align: center;'>No memory products available at the moment.</p>";
    }
    ?>
</div>
