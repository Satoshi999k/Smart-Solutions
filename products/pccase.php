...
$result = $conn->query("SELECT id, name, price, image, stock FROM products WHERE LOWER(category) LIKE '%case%' ORDER BY id DESC");
$products = [];
...
<meta charset="UTF-8">
    <title>PC CASE - SMARTSOLUTIONS</title>
<style>
        ...
        <div class="login profile-dropdown" style="position: relative; display: inline-block;">
            ...
            <div id="dropdown-menu" class="dropdown-content" style="display: none; position: absolute; background-color: #f9f9f9; min-width: 160px; box-shadow: 0px 8px 16px rgba(0, 0, 0, 0.2); z-index: 1; border-radius: 5px;">
                <?php if (isset($_SESSION['user_id'])): ?>
                    <a href="/ITP122/user/profile.php" style="color: black; padding: 12px 16px; text-decoration: none; display: block;">View Profile</a>
                    <a href="/ITP122/user/edit-profile.php" style="color: black; padding: 12px 16px; text-decoration: none; display: block;">Edit Profile</a>
                    <a href="/ITP122/user/logout.php" style="color: black; padding: 12px 16px; text-decoration: none; display: block;">Log Out</a>
                <?php endif; ?>
            </div>  
        </div>
        <div class="login-text">
            <?php if (isset($_SESSION['user_id'])): ?>
                <a href="/ITP122/user/profile.php"></a>
            <?php else: ?>
                <a href="/ITP122/user/register.php"><p>Login/<br>Sign In</p></a>
            <?php endif; ?>
        </div>
    </div>
    </header>
...
<div class="menu">
    <a href="/ITP122/index.php">HOME</a>
    <a href="/ITP122/pages/product.php">PRODUCTS</a>
    <a href="desktop.php">DESKTOP</a>
    <a href="laptop.php">LAPTOP</a>
    <a href="/ITP122/pages/brands.php">BRANDS</a>
</div>

<div class="breadcrumb">
    <a href="../index.php"><i class="material-icons" style="font-size: 16px; vertical-align: middle; margin-right: 4px;">home</i>Home</a> > 
    <a><i class="material-icons" style="font-size: 16px; vertical-align: middle; margin-right: 4px;">computer</i>PC Case</a>
</div>
