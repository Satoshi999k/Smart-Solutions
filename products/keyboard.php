...
$result = $conn->query("SELECT id, name, price, image, stock FROM products WHERE LOWER(category) = 'keyboard' ORDER BY id DESC");
$products = [];
...
<meta charset="UTF-8">
<title>Keyboard - SMART SOLUTIONS COMPUTER SHOP</title>
<style>
...
<div class="breadcrumb">
    <a href="../index.php"><span class="material-icons" style="vertical-align: middle; margin-right: 8px; font-size: 20px;">home</span>Home</a> > <span class="material-icons" style="vertical-align: middle; margin-right: 8px; font-size: 20px; color: #0062F6;">keyboard</span><a>Keyboard</a>
</div>
