...
$result = $conn->query("SELECT id, name, price, image, stock FROM products WHERE LOWER(category) LIKE '%processor%' ORDER BY id DESC");
$products = [];
...
<meta charset="UTF-8">
    <title>PROCESSOR - SMARTSOLUTIONS</title>
<style>
    body {
...
<div class="breadcrumb">
    ...
    <a><i class="material-icons" style="font-size: 16px; vertical-align: middle; margin-right: 4px;">memory</i>Processor</a>
</div>
...
<div class="product-grid">
    ...
    if (!empty($products)) {
        ...
        echo "<p style='grid-column: 1/-1; text-align: center;'>No processors available at the moment.</p>";
    }
    ?>
</div>
