...
$result = $conn->query("SELECT id, name, price, image, stock FROM products WHERE LOWER(category) = 'mouse' ORDER BY id DESC");
$products = [];
...
<meta charset="UTF-8">
    <title>MOUSE - SMARTSOLUTIONS</title>
<style>
    ...
    .breadcrumb i.material-icons { font-family: 'Material Icons'; font-size: 20px; vertical-align: middle; color: #0062F6; display: inline-flex; align-items: center; font-weight: normal; font-style: normal; letter-spacing: normal; text-transform: none; white-space: nowrap; word-wrap: normal; direction: ltr; line-height: 1; }
    .breadcrumb span.material-icons { font-family: 'Material Icons'; font-size: 20px; vertical-align: middle; color: #0062F6; display: inline-flex; align-items: center; font-weight: normal; font-style: normal; letter-spacing: normal; text-transform: none; white-space: nowrap; word-wrap: normal; direction: ltr; line-height: 1; }
    .breadcrumb > span:not(.material-icons) { display: inline-flex; align-items: center; color: #666; }
